...
public class CourseSearchServiceImpl implements CourseSearchService {
    ...
    public SearchPageResultDto<CourseIndex> queryCoursePubIndex(PageParams pageParams, SearchCourseParamDto courseSearchParam) {
        ...
        //根据查询字段构建布尔查询
        buildQueryParams(courseSearchParam, boolQueryBuilder);
        ...
        //得到匹配的课程列表
        SearchPageResultDto<CourseIndex> pageResult = handleResponse(pageNo, pageSize, searchResponse);
    ...
    private SearchPageResultDto<CourseIndex> handleResponse(Long pageNo, Long pageSize, SearchResponse searchResponse) {
    ...
    private void buildQueryParams(SearchCourseParamDto courseSearchParam, BoolQueryBuilder boolQueryBuilder) {
