...
public class ManagementController {
    ...
    @ApiImplicitParams(value = {
            ...
            @ApiImplicitParam(name = "bucket", value = "命名空间", required = true, dataType = "String", paramType="query")
    })
    @PostMapping(value = "/deleteFiles")
    public RestResponse<String> deleteFiles(@RequestParam("fileKeys") String[] fileKeys,@RequestParam("bukect") String bucket){
        return fileService.deleteFiles(fileKeys,bucket);
    }
