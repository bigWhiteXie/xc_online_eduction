...
public class HttpUtil {
    ...
    public static void writerError(RestErrorResponse restResponse, HttpServletResponse response) throws IOException {
        response.setContentType("application/json,charset=utf-8");
        response.setStatus(Integer.valueOf(restResponse.getErrCode()));
