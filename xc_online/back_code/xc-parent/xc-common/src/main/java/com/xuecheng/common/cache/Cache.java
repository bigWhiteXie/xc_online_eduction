package com.xuecheng.common.cache;
...
public interface Cache {
    ...
    /**
     * 把key 增加value数量
     *  (仅StringRedisTemplate能调用该方法)
     * @param key
     * @param value
     */
    default void inc (String key, Integer value) {
        throw new IllegalStateException("this method has not implements");
    }
